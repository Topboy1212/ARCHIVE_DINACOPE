...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Arial, sans-serif; }
        body { background-color: #d2e4f7; color: #1a2a40; display: flex; flex-direction: column; min-height: 100vh; }
        
        /* Section supérieure : Bleu nuit technologique */
        .top-banner {
            background: linear-gradient(rgba(5, 18, 46, 0.92), rgba(5, 18, 46, 0.95)), url('assets/uploads/WhatsApp%20Image%202026-05-24%20at%2000.02.38.jpeg');
        ...
        .welcome-text {
            color: #ffb703; /* Jaune doré officiel */
            font-size: 0.9rem;
            font-weight: 600;
        ...
        /* Section inférieure : Claire pour la lecture des missions */
        .missions-section {
            flex: 1;
            max-width: 1000px;
            margin: 0 auto;
        ...
        @media (max-width: 768px) {
            ...
            .ministry-title { border-left: none; padding-left: 0; text-align: center; }
            .ministry-title h1 { font-size: 2.2rem; }
            .missions-container { padding: 25px 15px; }
            .missions-container h2 { font-size: 1.4rem; }
        }
    </style>
</head>
<body>
